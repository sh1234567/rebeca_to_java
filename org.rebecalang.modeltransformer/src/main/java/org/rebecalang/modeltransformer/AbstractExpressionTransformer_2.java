...
public abstract class AbstractExpressionTransformer_2 {
	...
	public AbstractExpressionTransformer_2(Set<CompilerFeature> cFeatures, 
	...
	public abstract String translate(Expression expression,
			ExceptionContainer container, int fType);
